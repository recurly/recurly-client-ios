//
//  RecurlyApplePayTokenRequest.swift
//  RecurlySDK-iOS
//
...
public struct RecurlyApplePayTokenRequest: Codable, Sendable {
    var paymentData: RecurlyApplePaymentData
    var paymentMethod: RecurlyApplePaymentMethod
