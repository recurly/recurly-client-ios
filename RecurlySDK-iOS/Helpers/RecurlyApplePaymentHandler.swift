...
public class RecurlyApplePaymentHandler: NSObject {
    ...
    // Reference to RecurlyApplePayItem
     ...
     */
    public func startApplePayment(with applePayInfo: RecurlyApplePayInfo, completion: @escaping PaymentCompletionHandler) {
    ...
    // All information required to create an order is here 'RecurlyApplePayInfo'
    private func createPaymentRequest(with applePayInfo: RecurlyApplePayInfo) -> PKPaymentRequest {
        ...
        paymentRequest.supportedNetworks = RecurlyApplePaymentHandler.supportedNetworks
    ...
    public func applePaySupported() -> Bool {
        return PKPaymentAuthorizationViewController.canMakePayments() && PKPaymentAuthorizationViewController.canMakePayments(usingNetworks: RecurlyApplePaymentHandler.supportedNetworks)
    }
...
extension RecurlyApplePaymentHandler: PKPaymentAuthorizationControllerDelegate {
